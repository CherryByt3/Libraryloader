...
local CherryBeamImageManager = {
    Assets = {
        TransparencyTexture = {
            RobloxId = 139785960036434,
            Path = "CherryByt3/assets/TransparencyTexture.png",
            Id = nil
        },
        
        SaturationMap = {
            RobloxId = 4155801252,
            Path = "CherryByt3/assets/SaturationMap.png",
            Id = nil
        }
    }
}
do
    local BaseURL = "https://raw.githubusercontent.com/CherryByt3/LibraryLoader/refs/heads/main/"
    ...
    function CherryBeamImageManager.GetAsset(AssetName: string)
        if not CherryBeamImageManager.Assets[AssetName] then
            return nil
        end

        local AssetData = CherryBeamImageManager.Assets[AssetName]
    ...
    function CherryBeamImageManager.DownloadAsset(AssetPath: string)
        ...
        local URLPath = AssetPath:gsub("CherryBeam/", "")
        writefile(AssetPath, game:HttpGet(`{BaseURL}{URLPath}`))
    end

    for _, Data in CherryBeamImageManager.Assets do
        CherryBeamImageManager.DownloadAsset(Data.Path)
    end
end
...
do
    ...
    function Funcs:AddColorPicker(Idx, Info)
        ...
        local HolderTransparency = New("ImageLabel", {
            Image = CherryBeamImageManager.GetAsset("TransparencyTexture"),
        ...
        local SatVipMap = New("ImageButton", {
            BackgroundColor3 = ColorPicker.Value,
            Image = CherryBeamImageManager.GetAsset("SaturationMap"),
...
function Library:CreateWindow(WindowInfo)
    ...
    if Library.IsMobile then
        ...
        if WindowInfo.MobileButtonsSide == "Right" then
            ToggleButton.Button.Position = UDim2.new(1, -6000, 0, 6000)
            ToggleButton.Button.AnchorPoint = Vector2.new(1, 0)

            LockButton.Button.Position = UDim2.new(1, -6000, 0, 40000)
