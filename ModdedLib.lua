...
local SpectrezImageManager = {
    Assets = {
        TransparencyTexture = {
            RobloxId = 139785960036434,
            Path = "Spectr3zxHxcker/Assets/TransparencyTexture.png",
        ...
        SaturationMap = {
            RobloxId = 4155801252,
            Path = "Spectr3zxHxcker/Assets/SaturationMap.png",
...
do
    local BaseURL = "https://raw.githubusercontent.com/Spectr3zxHxcker/LibraryFrFr/main/"
    ...
    function SpectrezImageManager.GetAsset(AssetName: string)
        if not SpectrezImageManager.Assets[AssetName] then
            return nil
        end

        local AssetData = SpectrezImageManager.Assets[AssetName]
    ...
    function SpectrezImageManager.DownloadAsset(AssetPath: string)
        ...
        local URLPath = AssetPath:gsub("Spectr3zxHxcker/", "")
        writefile(AssetPath, game:HttpGet(`{BaseURL}{URLPath}`))
    end

    for _, Data in SpectrezImageManager.Assets do
        SpectrezImageManager.DownloadAsset(Data.Path)
    end
end
...
do
    ...
    function Funcs:AddColorPicker(Idx, Info)
        ...
        local HolderTransparency = New("ImageLabel", {
            Image = SpectrezImageManager.GetAsset("TransparencyTexture"),
        ...
        local SatVipMap = New("ImageButton", {
            BackgroundColor3 = ColorPicker.Value,
            Image = SpectrezImageManager.GetAsset("SaturationMap"),
